#!/usr/bin/env python3
# Quick test for Standard Poisson Image Editing
...
from poisson_editing import poisson_image_editing
...
print("=" * 60)
print(f"Testing Standard Poisson on: {img_name}")
print("=" * 60)
...
# Runs Standard Poisson Image Editing
print("Running Standard Poisson Image Editing...")
start = time.time()
result = poisson_image_editing(composite, background, mask)
...
cv2.imwrite('test_standard_result.png', out)
print(f"Saved: test_standard_result.png")
